...
import { X, User, Lock, Mail, Shield, Users, Code, Plus, Trash2, Eye, EyeOff } from 'lucide-react';
...
export const UserManagementModal = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-xs">
      <div className="bg-white w-full max-w-2xl rounded-2xl border border-slate-200 shadow-2xl overflow-hidden text-xs flex flex-col max-h-[90vh]">
        ...
        <div className="p-4 bg-slate-900 text-white flex items-center justify-between flex-shrink-0">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-bold text-sm">Kelola Akun & Hak Akses Pengguna</h2>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-6">
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-xl p-4">
            <h3 className="font-bold text-xs text-slate-800 mb-3 flex items-center gap-1">
              ...
              <span>Buat Akun Baru (Hanya untuk Admin)</span>
            </h3>

            {errorMsg && (
              <div className="mb-3 p-3 rounded-lg bg-rose-50 border border-rose-200 text-rose-800 text-xs font-semibold">
                {errorMsg}
              </div>
            )}
            {successMsg && (
            ...
            <form onSubmit={handleAddUser} className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
              <div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                    required
                    className="w-full bg-white border border-slate-300 rounded-xl pl-9 pr-10 py-2 text-slate-900 focus:outline-none focus:border-blue-600"
                  />
                  <button
                    type="button"
          ...
          <div className="space-y-3">
            <h3 className="font-bold text-xs text-slate-800 flex items-center gap-1.5">
              ...
              <span>Daftar Akun yang Terdaftar ({users.length})</span>
            </h3>
                            ...
                            {isEditing ? (
                              <div className="flex items-center gap-1.5 bg-slate-100 border border-slate-200 p-1.5 rounded-lg">
                                <div className="relative">
                                  <input
                                    ...
                                    className="bg-white border border-slate-300 rounded px-2 py-0.5 text-[11px] outline-none w-28 focus:border-blue-600"
                                  />
                                  <button
                                    type="button"
                                ...
                                <button
                                  ...
                                  className="px-2 py-0.5 bg-green-600 hover:bg-green-700 text-white rounded font-bold text-[10px]"
                                >
                                  Simpan
                                </button>
                                <button
                                  onClick={() => { setEditingUserId(null); setNewPasswordVal(''); }}
                                  className="px-2 py-0.5 bg-slate-300 hover:bg-slate-400 text-slate-700 rounded font-bold text-[10px]"
                                >
                                  Batal
                                </button>
                              </div>
                              ...
                              <>
                                <button
                                  ...
                                  className="px-2.5 py-1 border border-slate-300 rounded-lg hover:bg-slate-100 text-slate-700 font-bold"
                                >
                                  Ganti Password
                                </button>
                                {u.id !== 'usr-admin' && (
                                  <button
                                    ...
                                    className="p-1 hover:bg-rose-50 rounded-lg text-rose-600 hover:text-rose-700"

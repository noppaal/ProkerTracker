      ...
      <div className="bg-white w-full max-w-md rounded-2xl border border-slate-200 shadow-2xl overflow-hidden text-xs">
        ...
        <div className="p-3.5 bg-slate-50 border-b border-slate-200">
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              className="px-3 py-2 rounded-xl bg-amber-500/10 hover:bg-amber-500/20 text-amber-900 border border-amber-300 text-xs font-bold flex items-center justify-center gap-1.5 transition-all"
            >
            ...
            <button
              ...
              className="px-3 py-2 rounded-xl bg-blue-500/10 hover:bg-blue-500/20 text-blue-900 border border-blue-300 text-xs font-bold flex items-center justify-center gap-1.5 transition-all"
            >
        ...
        {activeTab === 'login' ? (
          ...
          <form onSubmit={handleRegister} className="p-5 space-y-3.5 text-xs">
            ...
            <div>
              <label className="block text-xs font-bold text-slate-700 mb-1">Peran / Hak Akses (RBAC)</label>
